this.WORDAILY = this.WORDAILY || {},
    this.WORDAILY.bundle = function (e) {
        "use strict";
        function a(e) {
            ...
            return o(t, [{
                ...
                value: function () {
                    ...
                    this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                        this.shadowRoot.querySelector("#hash").textContent = null === (e = window.WORDAILY) || void 0 === e ? void 0 : e.hash,
        ...
        customElements.define("game-toast", Aa),
            ...
            Ca("js", new Date);
        Ca("config", "", {
            app_version: null === (Ea = window.WORDAILY) || void 0 === Ea ? void 0 : Ea.hash,
            debug_mode: !1
        });
